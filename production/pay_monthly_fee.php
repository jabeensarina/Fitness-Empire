                  ...
                  <div class="field item form-group">
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 ">
                        ...
                        <input readonly="readonly" id="search" class="form-control" type="cell_no" name="cellno" maxlength="12" value="<?php echo $cell_no; ?>" onkeypress='return restrictAlphabets(event)' />
