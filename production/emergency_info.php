...
echo $name." ".$phone_no." ".$other_name." ".$phone_num;

$sql="INSERT INTO `emergency_info` (`id`,`name`,`phone_no`,`other_name`,`other_no`) VALUES ('','$name','$phone_no','$other_name','$phone_num')";
                                ...
                                <h2>Emergency Contact Person:</h2>
									...
									<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST">
                                        ...
                                        <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <input class="form-control" type="other_number"  name="number"  >
                                            </div>
										</div>

										<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">Other Name
											</label>
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="first-name"  class="form-control " name="other_name">
											</div>
										</div>
										<div class="field item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3  label-align">Phone Number <span class="required">*</span></label>
                                            <div class="col-md-6 col-sm-6">
                                                <input class="form-control" type="ph_number" class='number' name="ph_number"  >
