								...
								<div class="x_content">
									...
									<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST">
										...
										<div id='cnic' class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input class="form-control" id="cnicnumber" type="cnic_number" name="nic" maxlength="13" required="required"  onkeypress='return restrictAlphabets(event)'/> 
											</div>
										</div>
										...
										<div class="field item form-group">
											...
											<div class="col-md-6 col-sm-6">
												<input class="form-control" id="txtnumber" type="cell_number" name="cell_no" maxlength="11" required="required"  />
											</div>
										</div>
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="number" id="first-name" class="form-control " name="fees" required="required" onkeypress='return restrictAlphabets(event)'/>
											</div>
										</div>
										<br>
